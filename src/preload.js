...
contextBridge.exposeInMainWorld('desktopAPI', Object.freeze({
  ...
  getGlobalMapSettings: () => ipcRenderer.invoke('global:get-map-settings'),
  setGlobalMapSettings: (settings) => ipcRenderer.invoke('global:set-map-settings', settings),
  openCesiumTutorial: () => ipcRenderer.invoke('global:open-cesium-tutorial'),
